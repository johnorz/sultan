...
const CONFIG = {
  ...
  tiers: {
    ...
    platinum: {
      ...
      isVip: true,
      perks: ['F2F nearby', 'Group send', 'QR code', 'Link sharing'],
    ...
    diamond: {
      ...
      isVip: true,
      perks: ['Leaderboard', 'F2F nearby', 'Group send', 'QR code', 'Link sharing'],
      sendMethods: ['link', 'qr', 'nfc', 'radar'],
      canRadar: true,
      canNfc: true,
      canLeaderboard: true,
    ...
    sultan: {
      ...
      isVip: true,
      perks: ['Make it Rain', 'VIP badge', 'Exclusive animations', 'Leaderboard', 'F2F nearby'],
      sendMethods: ['link', 'qr', 'nfc', 'radar'],
      canRadar: true,
      canNfc: true,
      canLeaderboard: true,
